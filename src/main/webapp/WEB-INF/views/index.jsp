...
<body>
	...
	<div>
		...
		<div>
			<a href="signup">Add New Student</a>
		</div>
	</div>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td>
						<div>
							<a href="home/<%=student.getId()%>/edit">Edit</a> <a
								href="home/<%=student.getId()%>/delete" onclick="return confirm('Are you sure you want to delete this student?')">Delete</a><a
								href="home/<%=student.getId()%>">View</a>
						</div>
					</td>
				</tr>
				<%
